...
const LinkedInIcon = ({ size, label, link }) => {
  let width = "20px"
  let height = "20px"
  ...
  return (
    <a href={link} className="flex flex-col items-center justify-center group">
      <svg
        style={{ width: width, height: height }}
        className="hover:scale-125 transition-all duration-300 ease-in-out"
        viewBox="2 2 20 20" fill="#343C54" xmlns="http://www.w3.org/2000/svg">
      ...
      {label ? <p className="icon-text">LinkedIn</p> : null}
    </a>
  )
}
